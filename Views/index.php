                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Iniciar Sessión</h1>
                                    </div>
                                    <form class="user" id="formLogin" name="formLogin">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="inputClave" name="inputClave" placeholder="Contraseña">
                                        </div>
                                        <div class="alert alert-danger text-center d-none" id="alerta" role="alert">
                                        </div>
                                        <button class="btn btn-success btn-user btn-block" onClick="frmLogin(event);" type="submit">Login</button>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                            Todos los derechos reservados © <?php echo date("Y"); ?> por Point Sale
                            Ver. 1.0
                            </div>
                        </div>
                    </div>
